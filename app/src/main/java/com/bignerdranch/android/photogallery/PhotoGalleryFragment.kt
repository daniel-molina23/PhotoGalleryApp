...
class PhotoGalleryFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //set unmetered Network constraint aka WIFI
        // (Cellular Network is metered so it wont work)
        val constraints = Constraints.Builder()
            .setRequiredNetworkType(NetworkType.UNMETERED)
            .build()
        //make a one time work request with PollWorker and constraint
    ...
    private inner class PhotoAdapter(private val galleryItems:
        List<GalleryItem>) : RecyclerView.Adapter<PhotoHolder>(){
        ...
        override fun onBindViewHolder(holder: PhotoHolder,
            ...
            //provide blank ColorDrawable object if ContextCompat.getDrawable(...)
            // returns null
